...
--
-- SQLINES DEMO *** or table `teacher_availability`
--
...
--
-- SQLINES DEMO *** table `teacher_availability`
--

LOCK TABLES teacher_availability WRITE;
/* SQLINES DEMO *** LE `teacher_availability` DISABLE KEYS */;
/* SQLINES DEMO *** LE `teacher_availability` ENABLE KEYS */;
UNLOCK TABLES;
